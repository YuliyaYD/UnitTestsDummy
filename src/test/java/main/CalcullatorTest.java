...
//        Calculator calculator = new Calculator();
//        Assert.assertEquals(Integer.MAX_VALUE, calculator.add(Integer.MAX_VALUE - 1, 1));
//        Assert.assertEquals(Integer.MIN_VALUE, calculator.add(Integer.MIN_VALUE + 1, -1));
//    }
//
//
//    @Test
...
//        Calculator calculator = new Calculator();
//        Assert.assertEquals(Integer.MIN_VALUE, calculator.add(Integer.MAX_VALUE, 1));
//        Assert.assertEquals(Integer.MAX_VALUE, calculator.add(Integer.MIN_VALUE, -1));
...
//        Calculator calculator = new Calculator();
//        Assert.assertEquals(0, calculator.multiply(Integer.MAX_VALUE, 1));
//        Assert.assertEquals(0, calculator.multiply(Integer.MIN_VALUE, 1));
//    }
//
//
////не работает
...
//        Calculator calculator = new Calculator();
//        Assert.assertEquals(-30, calculator.subtract(-20, 10));
//    }
//
//    @Test
...
//        Assert.assertEquals(8, calculator.subtract(8, 0));
//
//    }
//
//    @Test
...
//        Calculator calculator = new Calculator();
//        Assert.assertEquals(Integer.MAX_VALUE, calculator.subtract(Integer.MAX_VALUE - 1, 1));
//        Assert.assertEquals(Integer.MIN_VALUE, calculator.subtract(Integer.MIN_VALUE + 1, -1));
//    }
